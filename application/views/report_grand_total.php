...
<div id="report_total" class="report_total row">
  ...
  <span class="col total_<?php echo ( $headers[ 0 ] == '' ) ? 'empty' : str_replace( '.','', str_replace( ' ','_', strtolower( $headers[ 0 ] ) ) ); ?>"><?php echo ( $headers[ 0 ] == '' ) ? '&nbsp;' : 0 ; ?></span>
  <span class="col total_<?php echo ( $headers[ 1 ] == '' ) ? 'empty' : str_replace( '.','', str_replace( ' ','_', strtolower( $headers[ 1 ] ) ) ); ?>"><?php echo ( $headers[ 1 ] == '' ) ? '&nbsp;' : 0 ; ?></span>
  <span class="col total_<?php echo ( $headers[ 2 ] == '' ) ? 'empty' : str_replace( '.','', str_replace( ' ','_', strtolower( $headers[ 2 ] ) ) ); ?>"><?php echo ( $headers[ 2 ] == '' ) ? '&nbsp;' : 0 ; ?></span>
</div>
